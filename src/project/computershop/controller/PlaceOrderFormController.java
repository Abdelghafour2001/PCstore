...
import project.computershop.dto.ItemTransactionDetailsDTO;
import project.computershop.dto.RepairTransactionDetailsDTO;
import project.computershop.dto.TransactionDTO;
import project.computershop.service.ServiceFactory;
import project.computershop.service.ServiceTypes;
...
import project.computershop.service.custom.TransactionService;
import project.computershop.util.CustomAlert;
import project.computershop.util.Regex;
import project.computershop.util.RegexType;
import project.computershop.view.tm.ItemCartTM;
import project.computershop.view.tm.RepairCartTM;
...
public class  PlaceOrderFormController {
                    ...
                    if (empty) {
                        ...
                        deleteIcon.setOnMouseClicked((MouseEvent event) -> {
                            ...
                            if (result == ButtonType.OK){
                                ...
                                netTotal -= total;
                                lblTotal.setText(NumberFormat.getCurrencyInstance(new Locale("en","ma")).format(netTotal));
    ...
    void PlaceOrderOnAction(ActionEvent event) {
        ButtonType btnResult= CustomAlert.getInstance().showAlert(Alert.AlertType.CONFIRMATION, "Place Payment","Total cost : "+NumberFormat.getCurrencyInstance(new Locale("en","ma")).format(netTotal)+"\nAre you confirm ? ");
