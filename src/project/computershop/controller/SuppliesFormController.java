...
import project.computershop.service.custom.SupplierService;
import project.computershop.service.custom.SuppliesService;
import project.computershop.util.CustomAlert;
import project.computershop.view.tm.SuppliesCartTM;
...
public class SuppliesFormController {
    ...
    void PlaceOrderOnAction(ActionEvent event) {
        ButtonType result= CustomAlert.getInstance().showAlert(Alert.AlertType.CONFIRMATION, "Place Supplies","Total cost : "+NumberFormat.getCurrencyInstance(new Locale("en","ma")).format(netTotal)+"\nAre you Sure ? ");
        if (result==ButtonType.OK) {
